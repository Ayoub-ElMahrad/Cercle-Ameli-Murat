...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>CERCLE AMELIE Murat</title>
        ...
        <div>
            ...
            <div class="tm-row pt-4">
                <div class="tm-col-left">
                    <a class="navLogo" href="file:///C:/Users/Ayoub/Desktop/templatemo_550_diagoona/index.html">
                        <div class="tm-site-header media">
                            <img src="./Diagoona HTML CSS Template_files/logomurat-40.png" class="mainLogo">
                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item active">
                                    <a class="nav-link tm-nav-link" href="file:///C:/Users/Ayoub/Desktop/templatemo_550_diagoona/index.html#">Accueil<span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="file:///C:/Users/Ayoub/Desktop/templatemo_550_diagoona/sommaire.html">Sommaire</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="file:///C:/Users/Ayoub/Desktop/templatemo_550_diagoona/services.html">Contact</a>
                                </li>                            
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="file:///C:/Users/Ayoub/Desktop/templatemo_550_diagoona/contact.html">Gestion</a>
                                </li>
                            </ul>                            
                        </div>                        
                    </nav>
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                        <h2 class="mb-5 tm-content-title">EVENEMENTS A VENIR : </h2>
                        <?php
...
?><p class="textejustifie"><b><i><?php echo $date_fr;?></i></b></p><?php;
?><p class="textejustifie"><b><?php echo $titre;?></b></p><?php;
?><p class="textejustifie"><?php echo $evenement;?></p><?php;
...
if ($mdp=="@murat")
{
?><a href="gestion.php?mdp=<?php=$mdp?>">GESTION</a><br><br><?php
}
else
{
?><div id="gestion"><a href="mdp1.php">GESTION</a></div><br><?php
}
?>

                        <hr class="mb-5">
                        <a class="nav-link tm-nav-link" href="/templatemo_550_diagoona/index.html#">Accueil<span class="sr-only">(current)</span></a>         
